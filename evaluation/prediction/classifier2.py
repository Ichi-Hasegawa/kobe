...
def exec_training(
    ...
    train_list, valid_list, test_list = load_dataset(
        root=root, annotation=annotation, split=split, synth_dirs=synth_dirs
    )
...
def main():
    synth_dirs = [
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/logarithm/80/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/logarithm/140/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/logarithm/200/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/max/80/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/max/140/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/max/200/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/mean/80/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/mean/140/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/mean/200/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/transmittance/80/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/transmittance/140/nifti"),
        Path("/net/nfs3/export/home/hasegawa/workspace/kobe/synthesis/_out/multi/ctxp/transmittance/200/nifti"),
    ]
    ...
    workdir = exec_training(
        ...
        label="hypoesthesia",
        work_root=Path("../_out/hypoesthesia").expanduser(),
        synth_dirs=synth_dirs
    )
