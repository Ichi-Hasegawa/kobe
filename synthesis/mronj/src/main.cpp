...
int main() {
    ...
    for (size_t i = 0; i < dataset.size(); i++) {
        ...
        cv::Mat img_intensity_hist = parida::draw_histogram(coronal_intensity_hist, coronal_intensity_curve, 
        ...
        cv::Mat img_coronal_mip = parida::draw_2d_image<PixelType>(coronal_mip);
        output_filename = input_number + ".jpg";
        ...
        cv::Mat img_roi_range = parida::draw_coronal_plane<PixelType>(coronal_mask, roi_range);
        output_filename = input_number + ".jpg";
        ...
        cv::Mat img_axial_mask = parida::draw_2d_image<PixelType>(axial_mask);
        output_filename = input_number + ".jpg";
        ...
        // cv::Mat img_sagittal_mip = parida::draw_2d_image<PixelType>(sagittal_mip);
        // output_filename = input_number + ".jpg";
